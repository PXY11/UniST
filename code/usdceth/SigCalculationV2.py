...
pricedata = pd.read_csv('../../data/usdceth/pricedata2021051020211110.csv',index_col=0)
...
#    dataCoin['VolLowerBelowmaQuantile50'] = dataCoin['pctStd'] < 0.035857 
    dataCoin['VolLowerBelowmaQuantile50'] = dataCoin['pctStd'] < 0.036 
...
#    dataCoin['VolHigherOvermaQuantile50Twosigma'] = dataCoin['pctStd'] > (0.038511 + 2*0.018451)
    dataCoin['VolHigherOvermaQuantile50Twosigma'] = dataCoin['pctStd'] > (0.03816 + 2*0.018)
    #当波动率高于Belowma的vol stat中的Quantile50的1.05倍时撤销池子
#    dataCoin['revoke_pos'] = dataCoin['pctStd'] > 0.035857 *1.05
    dataCoin['revoke_pos'] = dataCoin['pctStd'] > 0.036 *1.05
...
pricedata_res.to_csv('../../data/usdceth/pricedata_res2021051020211110.csv',index=True)
